...
import sys
from modeling_hubert_gpt2_adapters import GPT2EncoderXDecoder 
import wandb
...
wandb.init(project="EncoderXDecoder_vol2_full", name="EncoderXDecoder_HuBERT_GPT2_new_Baseline_adapters_full")
...
def evaluate(model, test_loader):
    ...
    print(f"Eval loss: {avg_loss:.4f} || Eval Perplexity: {perplexity:.4f} || Regularization loss: {reg_loss:.4f}")
