...
wandb.init(project="EncoderXDecoder_vol2_full", name="EncoderXDecoder_HuBERT_GPT2_reverse_adapters_unfrozen_full_regLoss")
...
output_dir = '/scratch/cvlachos/SpeechBrain_LCM/encoderXdecoder/hubert_gpt2_reverse_adapters_unfrozen_full_regLoss/'
