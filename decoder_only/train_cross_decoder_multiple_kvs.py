...
import sys
from cross_decoder_multiple_kvs import GPT2CrossDecoder 
import wandb
...
wandb.init(project="Cross_Decoder_Vol2", name="Cross_Decoder_GPT2_Multiple_KVs")
...
output_dir = '/efs/cvlachos/SpeechBrain_LCM/cross_decoder_multiple_kvs'
