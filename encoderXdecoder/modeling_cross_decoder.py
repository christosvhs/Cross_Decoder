...
class BERTEncoderXDecoder(nn.Module):
    ...
    def __init__(self, encoder_name = "facebook/hubert-base-ls960", decoder_name = "bert-base-uncased"):
        ...
        token_config = modeling_token_decoder.AutoConfig.from_pretrained(decoder_name)
        token_config.add_cross_attention=True
        token_config.is_decoder=True
        self.token_decoder = modeling_token_decoder.BertModel(token_config).to(self.device)
    ...
    def forward(self, input = None, encoder_attention_mask = None, labels = None, decoder_attention_mask=None):
        ...
        out = self.mask_decoder(input_ids=input_mask_decoder, attention_mask=decoder_attention_mask, encoder_hidden_states=out_token_decoder.last_hidden_state, labels = labels)
