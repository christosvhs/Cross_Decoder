...
from modeling_cross_decoder_gpt2_adapters_regLoss_tok import GPT2CrossDecoder 
from modeling_cross_decoder_gpt2_adapters_regLoss_tok import test_wer 
import wandb
...
wandb.init(project="EncoderXDecoder_vol2_full", name="EncoderXDecoder_HuBERT_GPT2_reverse_adapters_unfrozen_full_regLoss_small_tokenizer")
...
for epoch in range(start_epoch, max_epoch):
    ...
    for n, batch in enumerate(train_loader):
        ...
        if total_steps%(4*steps) == 0:
           print("Calculating WER...")
           wer = test_wer()
           print(wer)
           wandb.log({"Dev Clean WER": wer[0]})
           wandb.log({"Dev Other WER": wer[1]})
