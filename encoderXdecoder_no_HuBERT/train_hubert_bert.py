...
import sys
from modeling_hubert_bert import BERTEncoderXDecoder 
import wandb
...
wandb.init(project="EncoderXDecoder", name="EncoderXDecoder_HuBERT_BERT_Baseline")
...
output_dir = '/scratch/cvlachos/SpeechBrain_LCM/encoderXdecoder/hubert_bert_baseline'
