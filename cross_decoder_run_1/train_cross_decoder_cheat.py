...
import sys
from cross_decoder_cheat import GPT2CrossDecoder 
import wandb
...
wandb.init(project="Cross_Decoder", name="Cheat_Cross_Decoder_GPT2_Small")
...
output_dir = '/efs/cvlachos/SpeechBrain_LCM/cheater_cross_decoder'
