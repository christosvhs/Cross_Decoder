...
wandb.init(project="Cross_Decoder", name="Cross_Decoder_GPT2_Medium")
...
output_dir = '/efs/cvlachos/SpeechBrain_LCM/cross_decoder_medium'
...
#################################################### model loading
model = GPT2CrossDecoder(model_name)
